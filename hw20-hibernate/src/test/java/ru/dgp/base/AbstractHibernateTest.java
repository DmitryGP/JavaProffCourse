...
import static ru.dgp.demo.DbServiceDemo.HIBERNATE_CFG_FILE;
...
import ru.dgp.core.repository.DataTemplateHibernate;
import ru.dgp.core.repository.HibernateUtils;
import ru.dgp.core.sessionmanager.TransactionManagerHibernate;
import ru.dgp.crm.dbmigrations.MigrationsExecutorFlyway;
import ru.dgp.crm.model.Address;
import ru.dgp.crm.model.Client;
import ru.dgp.crm.model.Phone;
import ru.dgp.crm.service.DBServiceClient;
